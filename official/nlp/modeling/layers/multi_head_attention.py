...
@keras_export("keras.layers.MultiHeadAttention_local")
class MultiHeadAttention_local(Layer):
  """MultiHeadAttention_local layer.
  ...
  >>> layer = MultiHeadAttention_local(num_heads=2, key_dim=2)
  ...
  >>> layer = MultiHeadAttention_local(num_heads=2, key_dim=2, attention_axes=(2, 3))
  ...
  def __init__(self,
               ...
               **kwargs):
    super(MultiHeadAttention_local, self).__init__(**kwargs)
  ...
  def get_config(self):
    ...
    base_config = super(MultiHeadAttention_local, self).get_config()
  ...
  def call(self,
    ...
    #graph = self._output_dense.get_concrete_function(attention_output).graph
    #graph.as_graph_def()
