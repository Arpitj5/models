...
@keras_export("keras.layers.experimental.EinsumDense_w0")
class EinsumDense_w0(Layer):
  ...
  **Biased dense layer with einsums**
  ...
  >>> layer = EinsumDense_w0("ab,bc->ac", output_shape=64, bias_axes="c")
  ...
  **Applying a dense layer to a sequence**
  ...
  >>> layer = EinsumDense_w0("abc,cd->abd",
  ...
  **Applying a dense layer to a sequence using ellipses**
  ...
  >>> layer = EinsumDense_w0("...x,xy->...y", output_shape=64, bias_axes="y")
  >>> input_tensor = tf.keras.Input(shape=[32, 128])
  >>> output_tensor = layer(input_tensor)
  >>> output_tensor
  <... shape=(None, 32, 64) dtype=...>
  ...
  def __init__(self,
               ...
               **kwargs):
    super(EinsumDense_w0, self).__init__(**kwargs)
  ...
  def build(self, input_shape):
    ...
    if bias_shape is not None:
      ...
      self.bias = None
    super(EinsumDense_w0, self).build(input_shape)
  ...
  def get_config(self):
    ...
    base_config = super(EinsumDense_w0, self).get_config()
